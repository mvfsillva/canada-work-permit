...
export const TableItemEditButton = ({ handleEditApplication }: any) => (
  <td tw="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
    <a onClick={handleEditApplication} tw="text-indigo-600 hover:text-indigo-900 cursor-pointer">
      Edit
    </a>
  </td>
)
...
export const TableItemDetailsButton = () => (
  <td tw="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
    <a onClick={() => console.log('clicked')} tw="text-indigo-600 hover:text-indigo-900 cursor-pointer">
      Details
    </a>
  </td>
)
  ...
  return (
    <div tw="bg-white shadow overflow-hidden sm:rounded-lg">
      <div tw="px-4 py-5 sm:px-6">
        <h3 tw="text-lg leading-6 font-medium text-gray-900">Applicant Information</h3>
        <p tw="mt-1 max-w-2xl text-sm text-gray-500">Personal details and application.</p>
      </div>
      <div tw="border-t border-gray-200">
        <dl>
          <div tw="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd tw="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">Margot Foster</dd>
          </div>
          <div tw="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd tw="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">Backend Developer</dd>
          </div>
          <div tw="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt tw="text-sm font-medium text-gray-500">Email address</dt>
            <dd tw="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">margotfoster@example.com</dd>
          </div>
          <div tw="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt tw="text-sm font-medium text-gray-500">Salary expectation</dt>
            <dd tw="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">$120,000</dd>
          </div>
          <div tw="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
